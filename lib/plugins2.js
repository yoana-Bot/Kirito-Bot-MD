...
const pluginFolder = Helper.__dirname(join(__dirname, '../plugins2/index'))
const pluginFilter = filename => /\.(mc)?js$/.test(filename)


let watcher, plugins2, pluginFolders = []
watcher = plugins2 = {}
...
export { pluginFolder, pluginFilter, plugins2, watcher, pluginFolders, filesInit, deletePluginFolder, reload }