...
conn.reply(m.chat, `${emoji} Use correctamente el comando » ${usedPrefix + command} code`, m, rcanal)
return
}
...
msgRetry,
msgRetryCache,
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['kirito-MD (Sub Bot)', 'Chrome','2.0.0'],
version: version,
